...
#define MAVLINK_MESSAGE_INFO_SET_MODE { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 4, offsetof(mavlink_set_mode_t, target_system) }, \
         ...
         { "kcmvp_iv", NULL, MAVLINK_TYPE_UINT8_T, 16, 10, offsetof(mavlink_set_mode_t, kcmvp_iv) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SET_MODE { \
...
static inline uint16_t mavlink_msg_set_mode_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, uint8_t base_mode, uint32_t custom_mode, uint8_t kcmvp_alg, uint8_t kcmvp_mode, uint8_t kcmvp_key, uint8_t kcmvp_key_index, const uint8_t *kcmvp_iv)
{
    ...
    _mav_put_uint8_t_array(buf, 10, kcmvp_iv, 16);
...
{
    return mavlink_msg_set_mode_pack(system_id, component_id, msg, set_mode->target_system, set_mode->base_mode, set_mode->custom_mode, set_mode->kcmvp_alg, set_mode->kcmvp_mode, set_mode->kcmvp_key, set_mode->kcmvp_key_index, set_mode->kcmvp_iv);
}
...
{
    return mavlink_msg_set_mode_pack_chan(system_id, component_id, chan, msg, set_mode->target_system, set_mode->base_mode, set_mode->custom_mode, set_mode->kcmvp_alg, set_mode->kcmvp_mode, set_mode->kcmvp_key, set_mode->kcmvp_key_index, set_mode->kcmvp_iv);
}
...
static inline void mavlink_msg_set_mode_send(mavlink_channel_t chan, uint8_t target_system, uint8_t base_mode, uint32_t custom_mode, uint8_t kcmvp_alg, uint8_t kcmvp_mode, uint8_t kcmvp_key, uint8_t kcmvp_key_index, const uint8_t *kcmvp_iv)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SET_MODE_LEN];
    _mav_put_uint32_t(buf, 0, custom_mode);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_set_mode_send(chan, set_mode->target_system, set_mode->base_mode, set_mode->custom_mode, set_mode->kcmvp_alg, set_mode->kcmvp_mode, set_mode->kcmvp_key, set_mode->kcmvp_key_index, set_mode->kcmvp_iv);
#else
 ...
 */
static inline void mavlink_msg_set_mode_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t base_mode, uint32_t custom_mode, uint8_t kcmvp_alg, uint8_t kcmvp_mode, uint8_t kcmvp_key, uint8_t kcmvp_key_index, const uint8_t *kcmvp_iv)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field kcmvp_iv from set_mode message
 *
 * @return  Initializer Vector
 */
static inline uint16_t mavlink_msg_set_mode_get_kcmvp_iv(const mavlink_message_t* msg, uint8_t *kcmvp_iv)
{
    return _MAV_RETURN_uint8_t_array(msg, kcmvp_iv, 16,  10);
}
...
static inline void mavlink_msg_set_mode_decode(const mavlink_message_t* msg, mavlink_set_mode_t* set_mode)
{
    ...
    mavlink_msg_set_mode_get_kcmvp_iv(msg, set_mode->kcmvp_iv);
#else
