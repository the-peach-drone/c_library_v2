...
#define MAVLINK_COMMON_XML_HASH 2448293046197669163
...
/** @brief  */
#ifndef HAVE_ENUM_KCMVP_ALG
#define HAVE_ENUM_KCMVP_ALG
typedef enum KCMVP_ALG
{
   KCMVP_NOT_USE=0, /* disable KCMVP. | */
   KCMVP_ALG_AES=1, /* Use AES Algorithm. | */
   KCMVP_ALG_ARIA=2, /* USE ARIA Algorithm. | */
   KCMVP_ALG_SHA=3, /* USE SHA Algorithm. | */
   KCMVP_ALG_ENUM_END=4, /*  | */
} KCMVP_ALG;
#endif

/** @brief  */
#ifndef HAVE_ENUM_KCMVP_MODE
#define HAVE_ENUM_KCMVP_MODE
typedef enum KCMVP_MODE
{
   KCMVP_MODE_UNKNOWN=0, /* Unknown mode. | */
   KCMVP_MODE_CBC=1, /* Use CBC mode. | */
   KCMVP_MODE_CTR=2, /* Use CTR mode. | */
   KCMVP_MODE_GCM=3, /* Use GCM mode. | */
   KCMVP_MODE_ENUM_END=4, /*  | */
} KCMVP_MODE;
#endif
